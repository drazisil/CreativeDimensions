    ...
    public TeleporterCreative(WorldServer worldIn)
        ...
        public static Entity changeDimension(Entity entityIn, int dimensionIn)
        {
            if (!entityIn.worldObj.isRemote && !entityIn.isDead && entityIn instanceof EntityPlayerMP)
            {
                ...
                // entityIn.invulnerableDimensionChange = true;
                ...
                transferPlayerToDimension((EntityPlayerMP) entityIn, dimensionIn, new TeleporterCreative(((EntityPlayerMP) entityIn).getServerWorld()));
...
/*        if (this.worldServerInstance.provider.getDimensionType().getId() != 1)
    ...
    public class PortalPosition extends BlockPos
    {
        ...
        public static void transferPlayerToDimension(EntityPlayerMP player, int dimensionIn, net.minecraft.world.Teleporter teleporter)
        {
            ...
            player.isDead = false;
            player.getServer().getPlayerList().transferEntityToWorld(player, i, worldserver, worldserver1, teleporter);
