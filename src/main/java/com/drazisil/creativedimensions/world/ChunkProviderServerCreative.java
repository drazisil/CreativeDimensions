...
public class ChunkProviderServerCreative extends ChunkProviderServer {
    ...
    public ChunkProviderServerCreative(WorldServer worldObjIn, IChunkLoader chunkLoaderIn, IChunkGenerator chunkGeneratorIn)
    {
