...
public class CreativeChunk extends Chunk implements net.minecraftforge.common.capabilities.ICapabilityProvider {
    ...
    public CreativeChunk(World worldIn, int x, int z)
    {
        super(worldIn, x, z);
    ...
    public CreativeChunk(World worldIn, ChunkPrimer primer, int x, int z)
    {
        this(worldIn, x, z);
        int i = 256;
    ...
    {
        CreativeChunk chunk = (CreativeChunk) chunkProvider.getLoadedChunk(this.x, this.z - 1);
        CreativeChunk chunk1 = (CreativeChunk) chunkProvider.getLoadedChunk(this.x + 1, this.z);
        CreativeChunk chunk2 = (CreativeChunk) chunkProvider.getLoadedChunk(this.x, this.z + 1);
        CreativeChunk chunk3 = (CreativeChunk) chunkProvider.getLoadedChunk(this.x - 1, this.z);
        ...
        {
            CreativeChunk chunk4 = (CreativeChunk) chunkProvider.getLoadedChunk(this.x - 1, this.z - 1);
            ...
            if (this.world.isAreaLoaded(blockpos.add(-1, 0, -1), blockpos.add(16, this.world.getSeaLevel(), 16)))
            {
                ...
                if (this.isLightPopulated)
                {
                    for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
                    {
                        ...
                        // I have no clue what this does, pretty sure I can recreate it if needed
